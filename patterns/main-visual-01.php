...
<div class="wp-block-group alignfull">
	...
	<div class="wp-block-group alignfull is-style-hakoniwa-background-dot-01">
		...
		<div class="wp-block-buttons">
			...
			<div class="wp-block-button is-style-fill"><a class="wp-block-button__link wp-element-button" href="<?php echo get_admin_url( null, '/site-editor.php?postType=wp_template&postId=hakoniwa//home&canvas=edit' ); ?>"><?php echo esc_html_x( 'Edit Top Page', 'Pattern:Main Visual 01', 'hakoniwa' ); ?></a></div>
			<!-- /wp:button -->
