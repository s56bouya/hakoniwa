...
class Patterns {
	...
	public function register_block_pattern_categories(){
		$block_pattern_categories = array(
			'featured' => array( 'label' => __( 'Featured', Define::value( 'theme_name' ) ) ),
			'footer'   => array( 'label' => __( 'Footers', Define::value( 'theme_name' ) ) ),
			'header'   => array( 'label' => __( 'Headers', Define::value( 'theme_name' ) ) ),
			'query'    => array( 'label' => __( 'Query', Define::value( 'theme_name' ) ) ),
			'pages'    => array( 'label' => __( 'Pages', Define::value( 'theme_name' ) ) ),
		);
		 ...
		 * }
		 */
		$block_pattern_categories = apply_filters( Define::value( 'theme_name' ) . '_block_pattern_categories', $block_pattern_categories );
	
		foreach ( $block_pattern_categories as $name => $properties ) {
//				var_dump(WP_Block_Pattern_Categories_Registry::get_instance()->is_registered( $name ));
	...
	public function register_block_patterns() {
		 ...
		 */
		$block_patterns = apply_filters( Define::value( 'theme_name' ) . '_block_patterns', $block_patterns );
		...
		foreach ( $block_patterns as $block_pattern ) {
			...
			if( file_exists( $pattern_file ) ){
				register_block_pattern(
					Define::value( 'theme_name' ) . '/' . $block_pattern,
